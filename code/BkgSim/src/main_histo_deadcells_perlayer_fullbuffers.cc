...
int main(int const argc, char const * const * const argv) {
	...
	std::string const title = "Number of cells with full buffer per layer for subdetector " + subdetectornames + ";Layer number;Number of dead cells";
	TH1D *histo = new TH1D("histo", title.c_str(), 30, 0, 30);
