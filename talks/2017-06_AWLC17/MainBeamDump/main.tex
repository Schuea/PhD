...
\begin{frame}<1>[label=coolingtimesprev]
  ...
  \framezoom<1><2>(0.1cm,1.1cm)(5.0cm,3.7cm)                                                                                                                                                                                                
  \framezoom<1><2>(0.2cm,1.2cm)(5.1cm,3.6cm)                                                                                                                                                                                                
  \framezoom<1><2>(0.3cm,1.3cm)(5.2cm,3.5cm)                                                                                                                                                                                                
  \framezoom<1><2>(0.4cm,1.4cm)(5.3cm,3.4cm)                                                                                                                                                                                                
  \framezoom<1><2>(0.5cm,1.5cm)(5.4cm,3.3cm)                                                                                                                                                                                                
  \framezoom<1><2>(0.6cm,1.6cm)(5.5cm,3.2cm)                                                                                                                                                                                                
...
\begin{frame}
  ...
  \end{center}
\end{frame}
\againframe<2->[noframenumbering]{coolingtimesprev}
