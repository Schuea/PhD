...
\begin{columns}
 ...
 \end{column}
 \begin{column}{0.5\textwidth}
  The neutrons spread to positive x and y-direction. Within the tank, the neutrons are produced within the water vortex system. With the beam being stopped by the copper plates, the neutron production rate decreases.
 \end{column}
\end{columns}
  \centering
...
\begin{columns}
 ...
 \end{column}
 \begin{column}{0.5\textwidth}
  The neutrons again spread to positive x and y-direction. Within the tank, the point of highest neutron production is the high pressure water system. The production rate again decreases with the beam being stopped by the copper plates.
 \end{column}
\end{columns}
  \centering
\hspace*{1cm} x-direction \hfill y-direction \hfill z-direction \hspace*{1cm} \\
