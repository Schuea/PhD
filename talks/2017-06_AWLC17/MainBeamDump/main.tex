...
\begin{center}
\hspace*{1.6cm} Design 1 \hfill Design 2 \hspace*{1.8cm} \\
  \includegraphics[width=0.51\textwidth]{figures/Energy_deposition_1DMax_z_Design1_withLabels.pdf}
    \includegraphics[width=0.51\textwidth]{figures/Energy_deposition_1DMax_z_Design2_withLabels.pdf}
\end{center}
...
\hspace*{2cm} Design 1 \hfill Design 2 \hspace*{1.8cm} \\
  \includegraphics[width=0.51\textwidth]{figures/Dose_equivalent_1DMax_z_Design1_withLabels.pdf}
    \includegraphics[width=0.51\textwidth]{figures/Dose_equivalent_1DMax_z_Design2_withLabels.pdf}
\end{center}
...
\hspace*{1.8cm} Design 1 \hfill Design 2 \hspace*{2.3cm} \\
  \begin{center}
  \animategraphics[controls,loop,width=0.49\textwidth]{0.5}{DoseEQ_Time/Design1_}{1}{5}
  \animategraphics[controls,loop,width=0.49\textwidth]{0.5}{DoseEQ_Time/Design2_}{1}{5}
  \end{center}
\end{frame}
\begin{frame}
...
\begin{center}
  \includegraphics[width=0.7\textwidth]{figures/DoseEQ_Time_Comparison.pdf}
\end{center}
...
\hspace*{1cm} x-direction \hfill y-direction \hfill z-direction \hspace*{1cm} \\
  ...
  \includegraphics[width=0.31\textwidth]{figures/Neutron_flux_1DMax_z_Design1_withLabels.pdf}
\end{frame}
...
\hspace*{1cm} x-direction \hfill y-direction \hfill z-direction \hspace*{1cm} \\
  ...
  \includegraphics[width=0.31\textwidth]{figures/Neutron_flux_1DMax_z_Design2_withLabels.pdf}
\end{frame}
...
\hline
& & \multicolumn{1}{>{\centering}p{1.5cm}}{\textbf{Baseline 500}} & \multicolumn{1}{>{\centering}p{1.5cm}}{\textbf{Lumi Upgrade}} & \multicolumn{1}{>{\centering}p{1.5cm}}{\textbf{TeV Upgrade}} \\ 
\hline
\cline{1-5}
\hline
