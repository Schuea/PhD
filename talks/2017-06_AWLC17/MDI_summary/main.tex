...
\title[MDI Summary]{\textbf{\alert{AWLC 2017} \\\vspace*{0.2cm}\LARGE Summary of the\\MDI \& CFS sessions}}
\author{\textbf{Anne Sch\"utz}}
\institute{\textbf{DESY}}
\date{\textbf{28. June 2017}}

\titlegraphic{\hfil
    \includegraphics[height=1.0cm]{figures/ILC.jpeg}\hspace*{5cm}~%
   \includegraphics[height=1.0cm]{figures/CLIClogo.png}
   \hspace*{1.3cm}
}
