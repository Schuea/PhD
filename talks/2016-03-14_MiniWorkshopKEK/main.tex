...
\newcommand{\rhullogo}{
  ...
  \begin{textblock}{1}(295,12)
   \includegraphics[width=70pt,height=26pt]{figures/rhul_logo.png}
  \end{textblock}
}
\newcommand{\ejadelogo}{
  \setlength{\TPHorizModule}{1pt}
...
\end{itemize}
\begin{center}
 \includegraphics[height=4cm]{figures/3Danimation_EcalEndcap/Hits_3D_EcalEndcap_Layer_0.png}
\end{center}
\end{frame}
...
\only<2->{
  \includegraphics[height=0.4\textheight]{figures/3Danimation_EcalEndcap/Hits_3D_EcalEndcap_Layer_0.png}
   \includegraphics[height=0.4\textheight]{figures/3Danimation_EcalEndcap/Hits_3D_EcalEndcap_Layer_5.png}\\
    \includegraphics[height=0.4\textheight]{figures/3Danimation_EcalEndcap/Hits_3D_EcalEndcap_Layer_10.png}
     \includegraphics[height=0.4\textheight]{figures/3Danimation_EcalEndcap/Hits_3D_EcalEndcap_Layer_20.png}
}
\end{center}
...
Overnight stay in a traditional ryokan - \\ \flushright near the Snow Monkey park in Nagano.
 \begin{center}
 \includegraphics[width=0.55\textwidth]{figures/japanese_breakfast.jpg}
 \hspace*{0.3cm}
 \includegraphics[width=0.4\textwidth]{figures/snow_monkeys.jpg}
\end{center}
\end{frame}
