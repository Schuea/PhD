...
\sidlogo
 \begin{center}
\includegraphics[height=0.6\textheight]{figures/SiD_Occupancy.png}
\end{center}
...
\sidlogo
 \begin{center}
\includegraphics[height=0.65\textheight]{figures/muon_hittime_all_layers_SiTrackerEndcap.pdf}
\end{center}
\end{frame}
