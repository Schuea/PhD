...
\ilclogo
\includegraphics[width=0.52\textwidth]{figures/Helix_tracks_xz_1bunch_wo_momentum_cuts.pdf}
\includegraphics[width=0.52\textwidth]{figures/HelixEnvelopes_xz.pdf}
\end{frame}
\begin{frame}{The helix envelopes in the YZ plane}
\ilclogo
\includegraphics[width=0.52\textwidth]{figures/Helix_tracks_yz_1bunch_wo_momentum_cuts.pdf}
