...
\begin{center}
  \includegraphics[width=0.65\textwidth]{figures/ILCTDR-VOLUME_1_PhysicsGoals.pdf}
\end{center}
...
\end{itemize}
\hspace*{0.4cm}
 \includegraphics[width=0.43\textwidth]{figures/PhysicsMotivation-ILCPAC2012-Peskin_PrecisionHiggsCouplings.pdf}
 \hspace*{0.2cm}
 \includegraphics[width=0.4\textwidth]{figures/Higgs_Coupling_Precision_2013.pdf}
\end{frame}
...
\begin{frame}{Down grading the ILC?}
 \alert{The Japanese government asks for a cost reduction of ??\%.}\\ \vspace*{0.3cm}
 \visible<2->{
 To achieve such a dramatic cost reduction, the full machine needs to be down graded.\\
