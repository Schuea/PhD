...
By looking at their advantages and disadvantages, the differences between them will be compared.
 %The above sentence is fine, Phill
\end{chapterabstract}
\newline
...
%English in above sentences was fine, few small errors corrected, Phill
\begin{alignat}{5}
...
\caption[Schematic of FODO structure]{Schematic of FODO structures in the horizontal and vertical plane. The particles are focused and defocused by the quadrupoles that act as lenses. The overall beam envelope is compactified after a certain number of focusing and defocusing quadrupoles~\cite[p. 65]{Hinterberger}.}
\label{fig:FODO}
\end{figure}
