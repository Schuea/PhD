...
Its characteristic shape is called ``TESLA-style'', and its accelerating gradient exceeds \SI{35}{\mega\volt\per\meter}.~\cite[p. 15f]{TDR31}
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{Figures/Tesla_Cavity.jpg}
