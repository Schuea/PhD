...
\todo{Add a reference about the quality factor}
...
\todo{Let Phill check the English}
\\
...
This is due to the fact that the radius of the particle's path in an external magnetic field depends on the momentum of the particle, which is shown in more detail later on in Equation~\ref{eq:MagField_Radius}.
