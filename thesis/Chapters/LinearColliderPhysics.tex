...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{Figures/RFphase.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{Figures/Quadrupole.png}
...
The beta function $\beta$ is a measure of the spatial dependency of the amplitude and the wave length of the betatron oscillations.
