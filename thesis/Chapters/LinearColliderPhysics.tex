...
At such energies, the loss due to synchrotron radiation can be calculated as above, and is with \SI{3.79}{\GeV} (or \todo{convert GeV to MWh}) per beam still tolerable.
