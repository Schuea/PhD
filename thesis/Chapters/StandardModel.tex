...
\\The fermions explained in the paragraph above are subject to these fundamental forces, and can interact with each other by exchanging the gauge bosons, which are particles with a spin of +1.
\\The \textit{photon} is a massless particle mediating the electromagnetic force.
...
Due to their masses, the range of the weak interaction is limited to around \SI{10e-18}{\meter}.
