...
The production modes in high-energy lepton colliders are quite different from the production modes at the Large Hadron Collider (LHC) for instance.
At the LHC, proton beams are brought into collision, which interact mainly via gluon-gluon fusion processes.
\begin{figure}[h!]
\centering
