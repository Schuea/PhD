...
Since the EM interaction does not change the flavor of the particle, the photon therefore couples to all charged SM particles and their antiparticles, so that the charge is conserved in this interaction.
...
Similar to the electromagnetic interaction via a photon, the electric charge has to be conserved in the neutral current interaction as well.
Therefore, the flavor of the fermions involved in this interaction does not change, since only particle--antiparticle pairs are taking part.
Interaction involving a W boson on the other hand can either be between a lepton and a neutrino, or between an up- and a down-type quark. 
