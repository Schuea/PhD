...
The fermions are further categorized as leptons and quarks as well as in three generations, as can be seen in Figure~\ref{fig:SM}.
As leptons, the SM lists the electron and its heavier brothers, the muon and the tau, which have an electric charge of -1.
Their antiparticles are (as for all other particles in the SM) not described, since the same physics apply for them as well.
The only difference between particles and antiparticles is the sign of the 
a neutrino in their respective generation.
