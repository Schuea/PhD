...
\\When upgrading the ILC to later stages, such as the ILC500 and the ILC500 ``LumiUp'', the pair background occupancy rises, pushing the fraction of dead cells in the \sid vertex detector above the critical limit. \todo{English}
