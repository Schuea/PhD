...
In sub-figure (a), the rectangular shape in the hit distribution is the imprint of the tunnel.
...
As can be seen in Figure~\ref{fig:BDS_Muons:energy}, shifts the muon energy for a respective center-of-mass energy.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{Figures/BDS_muons/hittime_ILC500_spoilers_superimposed.pdf}
