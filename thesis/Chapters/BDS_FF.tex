...
A small production contribution on a few percent level comes additionally from direct annihilation of positrons with atomic electrons.
...
\begin{itemize}
 ...
 Its magnetic field strength is about \SI{16}{\kilo\gauss}~\cite{MuonShielding,Lewis}.\todo{Check shielding designs in TDR}
\end{itemize}
...
\\The motivation for the study presented in this section is to investigate the effect of the muons on the SiD detector, and whether the magnetized wall is necessary following the study of the detector performance in both shielding scenarios.
 \begin{figure}
 \centering
...
\begin{itemize}
 \item Event generation with MUCARLO - explain
 \item Table of muons per cross section for different spoiler scenarios - to be inserted
\end{itemize}

\subsection{Effect of muons on the SiD performance}
\label{BDS_Muons:SiD}
\begin{itemize}
 \item Insert PACMAN into SiD geometry  - RE-RUN THE SIMULATION!
