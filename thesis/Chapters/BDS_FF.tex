...
\\Additionally, the timing of the muons give reason to study possible time gates in the individual subdetectors.
Since the muons hit the muon system first and then penetrate the inner subdetector, there are distinct hit times.
