...
These numbers can therefore be used as input to a full detector simulation. \todo{Add reference to Glen's cross check}
...
The wall would then still serve as additional shielding but does not deflect charged particles. \todo{Maybe PACMAN magnetized or with different materials}
