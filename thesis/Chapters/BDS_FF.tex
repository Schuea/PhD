...
\end{enumerate}
So far, focusing the beam to a beam size of \SI{40}{\nano\metre} has been proven to be repeatable. \todo{English}
...
A light \todo{light guiding} pipe, with a profile area of \SI{10}{\centi\metre\squared} and a total length of \SI{35}{\centi\metre}, directs the light from the aerogel to the PMT.
...
At around \SI{800}{\volt}, the effect of dark current \todo{Explain dark current} in the PMT becomes prominent, because of which the noise rises exponentially. \todo{What is ADC?}
