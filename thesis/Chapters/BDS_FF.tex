...
There is only one red muon track line, which belongs to a negatively charged muon.
...
\\The main sources of muons were identified in the BDS to be 12 different distinct collimators.
...
\begin{itemize}
 ...
 \item Absorbers (radiation length: 20 X\textsubscript{0}):\\ \todo{20 or 30rl?}
