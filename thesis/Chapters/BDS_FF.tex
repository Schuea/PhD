...
These 4-vectors can therefore be used as input to a full detector simulation. 
...
After a file-format conversion, the \mucarlo output files containing the 4-vectors of the muons for the different shielding scenarios and center-of-mass energies served as the particle source input to \slic.
