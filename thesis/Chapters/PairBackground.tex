...
\end{figure}
The pair density is then plotted using the algorithm to calculate the position in x and y for a given position in z.

 \begin{figure}[h]
 \centering
  \begin{subfigure}[b]{0.49\textwidth}
   \centering
    \includegraphics[width=\textwidth]{Figures/Pairs/Helix_tracks_xz_80bunches_500GeV_5T}
   \caption{xz-plane}
   \end{subfigure}
   \hfill
    \begin{subfigure}[b]{0.49\textwidth}
   \centering
    \includegraphics[width=\textwidth]{Figures/Pairs/Helix_tracks_yz_80bunches_500GeV_5T}
   \caption{yz-plane}
   \end{subfigure}
   \caption[Pair background density for ILC500]{}
   \label{fig:PairBkg:Density}
 \end{figure}
 
 \begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{Figures/Pairs/HelixEnvelopes_COMPARISON_xz_500_350_250_comparison_EDITED_2.png}
    \caption[Comparison of the pair background envelopes for 250, 350, and \SI{500}{\GeV}]{
    }
    \label{fig:PairBkg:Envelopes}
\end{figure}
