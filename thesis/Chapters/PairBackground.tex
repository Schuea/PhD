...
\begin{chapterabstract}
 At the International Linear Collider, the collisions of the two lepton beams are accompanied by the production of background particles.
...
\\Since the ASCII files cannot directly serve as input to a full \geant~\cite{geant_ref,geant_ref2} detector simulation, a conversion tool was written for analysis studies in the context of this thesis, and instructions on its usage are available in~\cite{Confluence}. 
