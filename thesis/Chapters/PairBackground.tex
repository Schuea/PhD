...
The ratio for set (A) is still below the critical limit with about \num{4.2e-5}.\\
 ...
 \centering
  \begin{subfigure}[b]{0.49\textwidth}
   ...
   \caption{\sid vertex detector \textbf{barrel}, normalized occupancy}
   \end{subfigure}
   \hfill
    \begin{subfigure}[b]{0.49\textwidth}
   \centering
  ...
  \begin{subfigure}[b]{0.49\textwidth}
   ...
   \caption{\sid vertex detector \textbf{endcaps}, normalized occupancy}
   \end{subfigure}
   \hfill
    \begin{subfigure}[b]{0.49\textwidth}
   \centering
...
\todo{Over critical limit -> time to exchange sensors}
