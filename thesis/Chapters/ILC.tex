...
On the other hand, the options with a longer tunnel would give a more positive sign to the ILC community that an energy upgrade is foreseen for the future.
\begin{figure}[h]
\centering
...
The 40 active layers of the HCAL will contain scintillators measuring particle showers that are developing in the steel layers in between.\todo{RPC or scintillator?}
