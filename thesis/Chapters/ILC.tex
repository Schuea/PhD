...
\begin{table}
\caption{Beam parameters for different phases in the ILC operation scenario (ILC250, Baseline 500, Luminosity Upgrade, TeV Upgrade)~\multicitep{TDR1, p. 11; CR-0016} in comparison to LHC beam parameters~\cite{SiDBkgNote}}.
