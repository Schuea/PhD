...
Therefore, the SiD detector is optimized for Particle Flow Algorithms (PFA).
...
\begin{table}
\caption{Key parameters of the baseline SiD design. (All dimension are given in cm).\cite{SiDBkgNote}}
