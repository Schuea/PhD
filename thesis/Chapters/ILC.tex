...
Since $h\rightarrow WW^*$ has a large branch ratio for the known Higgs mass of \SI{125}{\GeV} (see Figure~\ref{fig:HiggsBR}), this process can be measured with high precision, and is therefore used for the calculation of the total Higgs decay width.
\begin{figure}[h]
\centering
...
\label{fig:HiggsBR}
\end{figure}
The branching ratio is calculated by dividing the measured rate of the event of interest by the Higgsstrahlung cross section.
