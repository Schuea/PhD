...
Entering the straight sections from inaccurate \todo{Better word for ``not ideal''?} orbits causes orbit distortions and aberrations in the straight sections, which again cause a rise in the beam emittance.
...
\todo{Show plot of cavity gradient}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.52\textwidth]{Figures/ILC-site.png}
