...
With all of these particles hitting the forward system, the BeamCal is expected to have an occupancy of 100\,\%, i.e. all of the BeamCal pixels are expected to be hit by particles.
...
\begin{itemize}
 ...
 Since the diverging L* values mean different beam operation depending on which detector was in use, CR-002 dictated a change of the detector designs in such a way to have the same L* for both detectors, in order to facilitate the beam operation.\\
