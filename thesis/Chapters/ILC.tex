...
For the creation of the positrons, the electron beam is used, which is guided through the \SI{231}{\meter} long helical undulator after being pre-accelerated.
...
One of the first sub-systems is the initial bunching and pre-acceleration of the beam with normal-conducting RF cavities.
...
In a second step, the beams are then accelerated again which increases their momenta in the desired direction.
