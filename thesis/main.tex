...
\usepackage{textcomp}
\usepackage{siunitx}
\usepackage{eurosym} %For the EURO symbold
\usepackage{bm}
\usepackage{upgreek}
%\usepackage[]{units}
\usepackage{tabularx}
...
\widowpenalties=3 10000 10000 150 %For avoiding single words or lines on the next page

\usepackage{float}%for figures in minipages
...
\newcommand{\designone}{\mbox{Design 1}\xspace}
\newcommand{\designtwo}{\mbox{Design 2}\xspace}
...
\DeclareSIUnit\xzero{X\textsubscript{0}}
...
\include{Chapters/Introduction}          %%% include all chapters in order
\include{Chapters/StandardModel}
\include{Chapters/LinearColliderPhysics}
\include{Chapters/ILC}
%%\include{Chapters/BackgroundTools}
\include{Chapters/PairBackground}
\include{Chapters/BDS_FF}
\include{Chapters/ATF}
\include{Chapters/BeamDumps}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TODO:Change 'ratio' to 'fraction' in the text
%TODO:cite before full stop
%TODO:Subfigure-Bennenung im Text einheitlich: 3 (a) und nicht 3a
%TODO:Make short captions more useful
%TODO:interaction point
%TODO:Remove the todo list
